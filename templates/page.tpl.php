  ...
  <div id="main-wrapper">
    ...
    <footer id="footer" role="contentinfo">
        <div class="footer-wrapper clearfix">
            ...
            <?php if ($is_front): ?>More <a rel="nofollow" href="http://www.templatemonster.com/category/art-drupal-templates/" target="_blank">Art Drupal Templates at TemplateMonster.com</a><?php endif; ?>
        </div><!-- /#footer-wrapper -->
    </footer><!-- /#footer -->
